...
void DadaUnaListaCon10000Elementos_CuandoSeBorraElElemento5000_EntoncesDevuelve0(){
	//Organizar
	lista_t* lista = lista_crear();
	if(!lista) return;
	...
	//Verificar
	if(!lista_borrar_de_posicion(lista, 5000)){
		printf("TEST PASADO: 'Lista borra posicion 5000 correctamente' \n");
	} else printf("TEST NO PASADO: 'Lista borra posicion 5000 correctamente'\n");
	lista_destruir(lista);
}
...
void prueba_extra_1(){
	...
	lista_insertar_en_posicion(lista, &numero_2, 1000);
	lista_insertar_en_posicion(lista, &numero_1, 0);
	lista_insertar_en_posicion(lista, &numero_3, 2);

	printf("\n\nTEST ESPECIAL\n");
	printf("El primer numero deberia ser 1 y es: %i\n", *(int*)lista_elemento_en_posicion(lista, 0));
	printf("El segundo numero deberia ser 2 y es: %i\n", *(int*)lista_elemento_en_posicion(lista, 1));
	printf("El tercer numero deberia ser 3 y es: %i\n", *(int*)lista_elemento_en_posicion(lista, 2));

	lista_borrar_de_posicion(lista, 1);
	printf("Ahora que borré el del medio: \n");
	printf("El primer numero deberia ser 1 y es: %i\n", *(int*)lista_elemento_en_posicion(lista, 0));
	printf("El segundo numero deberia ser 3 y es: %i\n", *(int*)lista_elemento_en_posicion(lista, 1));
...
int main(){
	...
	DadaUnaListaCon10000Elementos_CuandoSeBorraElElemento5000_EntoncesDevuelve0();
